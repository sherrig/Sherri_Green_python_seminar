...
charge = [1, 0, 1, -2e-10]                                   # Charges are represented as [x, y, z, q]
q[0] = charge
q[1] = [-1, 0, 1, 2e-10]
q[2] = [0, 1, -1, -1e-10]
q[3] = [0, -1, -1, 1e-10]
...
E_0vector = arrow(axis = (E_0[0], E_0[1], E_0[2]), color = color.red, pos = (0,0,0))
...
E_1vector = arrow(axis = (E_1[0], E_1[1], E_1[2]), color = color.green, pos = (0, 0, 0))
...
E_2vector = arrow(axis = (E_2[0], E_2[1], E_2 [2]), color = color.blue, pos = (0, 0, 0))
...
E_3vector = arrow (axis = (E_3[0], E_3[1], E_3[2]), pos = (0,0,0), color = color.yellow)
...
E_tot[2] = E[0][2] + E[1][2] + E[2][2] + E[3][2]

Etotvector = arrow (axis = (E_tot[0], E_tot[1], E_tot[2]),
                    pos = (0,0,0), color = color.magenta)

                                                                    # E_tot will be enormous because a
